...
export default function Header() {
  ...
  const categories = [
    ...
    { name: '기공', count: CATEGORY_TOTALS['기공']?.toLocaleString() || '0' },
    ...
    { name: '인상/보철', count: CATEGORY_TOTALS['인상/보철']?.toLocaleString() || '0' },
    { name: '절삭/연마재', count: CATEGORY_TOTALS['절삭/연마재']?.toLocaleString() || '0' },
    { name: '의약품', count: CATEGORY_TOTALS['의약품']?.toLocaleString() || '0' },
    { name: '장비', count: CATEGORY_TOTALS['장비']?.toLocaleString() || '0' },
    { name: '보존/근관', count: CATEGORY_TOTALS['보존/근관']?.toLocaleString() || '0' },
